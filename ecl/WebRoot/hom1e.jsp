...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 吗4.01 Transitional//EN">
<html>
<head>
					...
					<li class="nav-item"><a class="nav-link"
						...
						class="sr-only">(current)</span></a></li>
							...
							<li class="nav-item"><a class="nav-link"
								...
								<li class="nav-item"><a class="nav-link"
									href="<c:url value='/UserServlet?method=quit' />">退出登录</a></li>
								</ul>
							</div>
						</nav>
					</div>
							...
							<div class="row">
								...
								<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
									...
									<div class="rightarea">
										...
										<a href="<c:url value='/CatalogServlet?method=myCatalogRoot' />">我的文件</a>>>
